import {l as j, o as r, b as u, m as T, p as B, j as A, u as U, d as m, t as S, f as w, w as p, i as P, g, s as V, v as z, e as f, F as E} from "./vendor-vue.fe7e75bd.js";
import {_ as D} from "./UiButton.bf5404bc.js";
const G = {
    __name: "MetaPixel",
    props: {
        metaPixelId: {
  ...
  , W = B({
    ...
    setup(n, {emit: e}) {
        const t = n
          , [i] = A();
        let c = null;
        c = window == null ? void 0 : window.localStorage.getItem(t == null ? void 0 : t.storageKey),
        ...
        return (o,l)=>{
            const s = D;
            return U(i) ? (r(),
            u("div", H, [m("div", O, [m("p", J, S(n.content), 1), m("div", Q, [w(s, {
                theme: "primary",
                onClick: a
            }, {
                default: p(()=>[P(" Accept all ")]),
                _: 1
            }), w(s, {
                theme: "link",
                href: n.policyLink,
  ...
  , ee = B({
    ...
    setup(n) {
        ...
        const t = (e == null ? void 0 : e.siteUrl) && new URL(e == null ? void 0 : e.siteUrl)
          , i = `${(l = t == null ? void 0 : t.hostname) == null ? void 0 : l.replace("www.", "")}${t == null ? void 0 : t.pathname}-cookie-accept`;
        let c = null;
        c = window == null ? void 0 : window.localStorage.getItem(i);
        const a = V(!1);
        (d = (s = e == null ? void 0 : e.siteConfig) == null ? void 0 : s.cookieConsent) != null && d.visible && c === "true" ? a.value = !0 : (_ = (y = e == null ? void 0 : e.siteConfig) == null ? void 0 : y.cookieConsent) != null && _.visible ? a.value = !1 : a.value = !0;
        const o = h=>{
            h === !0 && (a.value = !0)
        }
        ;
        return (h,X)=>{
            ...
            const $ = W
              ...
              , M = G;
            return r(),
            u(E, null, [w($, z((x = n.siteConfig) == null ? void 0 : x.cookieConsent, {
                onConsent: o,
                storageKey: i
            }), null, 16), a.value && ((v = n.siteConfig) != null && v.g4aId) ? (r(),
            f(q, {
                key: 0,
                g4aId: (I = n.siteConfig) == null ? void 0 : I.g4aId
            }, null, 8, ["g4aId"])) : g("v-if", !0), a.value && ((C = n.siteConfig) != null && C.gtmId) ? (r(),
            f(N, {
                key: 1,
                gtmId: (b = n.siteConfig) == null ? void 0 : b.gtmId
            }, null, 8, ["gtmId"])) : g("v-if", !0), a.value && ((k = n.siteConfig) != null && k.metaPixelId) ? (r(),
            f(M, {
                key: 2,
                metaPixelId: (L = n.siteConfig) == null ? void 0 : L.metaPixelId
            }, null, 8, ["metaPixelId"])) : g("v-if", !0)], 64)
        }
    }
});
export {ee as _};
